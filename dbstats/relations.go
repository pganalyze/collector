...
func GetRelations(db *sql.DB, postgresVersion snapshot.PostgresVersion, collectBloat bool) ([]snapshot.Relation, error) {
	...
	relations := make(map[snapshot.Oid]snapshot.Relation, 0)
