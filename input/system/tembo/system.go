...
func GetSystemState(server *state.Server, logger *util.Logger) (system state.SystemState) {
	...
	if err != nil {
		server.SelfCheck.MarkCollectionAspectError(state.CollectionAspectSystemStats, "error getting CPU info: %v", err)
	...
	if err != nil {
		server.SelfCheck.MarkCollectionAspectError(state.CollectionAspectSystemStats, "error getting memory info: %v", err)
	...
	if err != nil {
		server.SelfCheck.MarkCollectionAspectError(state.CollectionAspectSystemStats, "error getting disk info: %v", err)
