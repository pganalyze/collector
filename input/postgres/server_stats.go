...
func GetServerStats(ctx context.Context, h CollectionHelper, db *sql.DB, ps state.PersistedState, ts state.TransientState) (state.PersistedState, state.TransientState, error) {
