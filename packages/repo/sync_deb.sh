...
mkdir -p /repo/ubuntu/precise/conf
cp /root/deb.distributions /repo/ubuntu/precise/conf/distributions
reprepro --basedir /repo/ubuntu/precise includedeb stable /deb/upstart/$DEB_PACKAGE
