...
rpm --addsign /rpm/systemd/$RPM_PACKAGE_AMD64
...
rpm --checksig /rpm/systemd/$RPM_PACKAGE_AMD64

mkdir -p /repo/el/7/RPMS
cp /rpm/systemd/$RPM_PACKAGE_X86_64 /repo/el/7/RPMS/
cp /rpm/systemd/$RPM_PACKAGE_AMD64 /repo/el/7/RPMS/
...
cp /rpm/systemd/$RPM_PACKAGE_AMD64 /repo/el/8/RPMS/
...
cp /rpm/systemd/$RPM_PACKAGE_AMD64 /repo/fedora/34/RPMS/
...
cp /rpm/systemd/$RPM_PACKAGE_AMD64 /repo/fedora/35/RPMS/
