...
func (*VacuumReportData) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*VacuumStatistic) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func init() { proto.RegisterFile("vacuum_report.proto", fileDescriptor9) }
