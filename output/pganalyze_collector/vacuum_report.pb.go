...
type VacuumReportData struct {
	...
	VacuumStatistics         []*VacuumStatistic   `protobuf:"bytes,20,rep,name=vacuum_statistics,json=vacuumStatistics" json:"vacuum_statistics,omitempty"`
	AutovacuumMaxWorkers     int32                `protobuf:"varint,30,opt,name=autovacuum_max_workers,json=autovacuumMaxWorkers" json:"autovacuum_max_workers,omitempty"`
	AutovacuumNaptimeSeconds int32                `protobuf:"varint,31,opt,name=autovacuum_naptime_seconds,json=autovacuumNaptimeSeconds" json:"autovacuum_naptime_seconds,omitempty"`
}
...
func (*VacuumReportData) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
type VacuumStatistic struct {
	...
	LiveRowCount                    int32          `protobuf:"varint,10,opt,name=live_row_count,json=liveRowCount" json:"live_row_count,omitempty"`
	DeadRowCount                    int32          `protobuf:"varint,11,opt,name=dead_row_count,json=deadRowCount" json:"dead_row_count,omitempty"`
	Relfrozenxid                    int32          `protobuf:"varint,12,opt,name=relfrozenxid" json:"relfrozenxid,omitempty"`
	Relminmxid                      int32          `protobuf:"varint,13,opt,name=relminmxid" json:"relminmxid,omitempty"`
	LastManualVacuumRun             *NullTimestamp `protobuf:"bytes,14,opt,name=last_manual_vacuum_run,json=lastManualVacuumRun" json:"last_manual_vacuum_run,omitempty"`
	LastAutoVacuumRun               *NullTimestamp `protobuf:"bytes,15,opt,name=last_auto_vacuum_run,json=lastAutoVacuumRun" json:"last_auto_vacuum_run,omitempty"`
	LastManualAnalyzeRun            *NullTimestamp `protobuf:"bytes,16,opt,name=last_manual_analyze_run,json=lastManualAnalyzeRun" json:"last_manual_analyze_run,omitempty"`
	LastAutoAnalyzeRun              *NullTimestamp `protobuf:"bytes,17,opt,name=last_auto_analyze_run,json=lastAutoAnalyzeRun" json:"last_auto_analyze_run,omitempty"`
	Fillfactor                      int32          `protobuf:"varint,18,opt,name=fillfactor" json:"fillfactor,omitempty"`
	AutovacuumEnabled               bool           `protobuf:"varint,20,opt,name=autovacuum_enabled,json=autovacuumEnabled" json:"autovacuum_enabled,omitempty"`
	AutovacuumVacuumThreshold       int32          `protobuf:"varint,21,opt,name=autovacuum_vacuum_threshold,json=autovacuumVacuumThreshold" json:"autovacuum_vacuum_threshold,omitempty"`
	AutovacuumAnalyzeThreshold      int32          `protobuf:"varint,22,opt,name=autovacuum_analyze_threshold,json=autovacuumAnalyzeThreshold" json:"autovacuum_analyze_threshold,omitempty"`
	AutovacuumVacuumScaleFactor     float64        `protobuf:"fixed64,23,opt,name=autovacuum_vacuum_scale_factor,json=autovacuumVacuumScaleFactor" json:"autovacuum_vacuum_scale_factor,omitempty"`
	AutovacuumAnalyzeScaleFactor    float64        `protobuf:"fixed64,24,opt,name=autovacuum_analyze_scale_factor,json=autovacuumAnalyzeScaleFactor" json:"autovacuum_analyze_scale_factor,omitempty"`
	AutovacuumFreezeMaxAge          int32          `protobuf:"varint,25,opt,name=autovacuum_freeze_max_age,json=autovacuumFreezeMaxAge" json:"autovacuum_freeze_max_age,omitempty"`
	AutovacuumMultixactFreezeMaxAge int32          `protobuf:"varint,26,opt,name=autovacuum_multixact_freeze_max_age,json=autovacuumMultixactFreezeMaxAge" json:"autovacuum_multixact_freeze_max_age,omitempty"`
	AutovacuumVacuumCostDelay       int32          `protobuf:"varint,27,opt,name=autovacuum_vacuum_cost_delay,json=autovacuumVacuumCostDelay" json:"autovacuum_vacuum_cost_delay,omitempty"`
	AutovacuumVacuumCostLimit       int32          `protobuf:"varint,28,opt,name=autovacuum_vacuum_cost_limit,json=autovacuumVacuumCostLimit" json:"autovacuum_vacuum_cost_limit,omitempty"`
}
...
func (*VacuumStatistic) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func init() { proto.RegisterFile("vacuum_report.proto", fileDescriptor10) }
