...
type RelationInformation_Column struct {
	...
	TypeIdx      int32                                  `protobuf:"varint,8,opt,name=type_idx,json=typeIdx,proto3" json:"type_idx,omitempty"`
}
...
func (x *RelationInformation_Column) GetTypeIdx() int32 {
	if x != nil {
		return x.TypeIdx
	}
	return 0
...
var file_full_snapshot_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0x81, 0x10, 0x0a, 0x13, 0x52, 0x65, 0x6c, 0x61,
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xab, 0x02,
	...
	0x12, 0x19, 0x0a, 0x08, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x69, 0x64, 0x78, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x07, 0x74, 0x79, 0x70, 0x65, 0x49, 0x64, 0x78, 0x1a, 0xcb, 0x01, 0x0a, 0x0f,
...
var file_full_snapshot_proto_goTypes = []interface{}{
	...
	(*NullDouble)(nil),                          // 46: pganalyze.collector.NullDouble
}
var file_full_snapshot_proto_depIdxs = []int32{
	...
	46, // 60: pganalyze.collector.RelationInformation.ColumnStatistic.correlation:type_name -> pganalyze.collector.NullDouble
