...
type VacuumProgressInformation struct {
	...
	StartedAt       *google_protobuf.Timestamp `protobuf:"bytes,6,opt,name=started_at,json=startedAt" json:"started_at,omitempty"`
...
func (*VacuumProgressInformation) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (m *VacuumProgressInformation) GetStartedAt() *google_protobuf.Timestamp {
	if m != nil {
		return m.StartedAt
	}
	return nil
...
func (*VacuumProgressStatistic) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
var fileDescriptor2 = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0x94, 0x94, 0x51, 0x6f, 0xe3, 0x44,
