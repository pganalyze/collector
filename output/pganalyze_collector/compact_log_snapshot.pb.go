...
const (
	...
	// The following are recognized by the collector to avoid stitching them onto
	// the previous line, but are currently not shipped to the server.
	LogLineInformation_LOCATION  LogLineInformation_LogLevel = 14
	LogLineInformation_BACKTRACE LogLineInformation_LogLevel = 15
)
...
const (
	...
	LogLineInformation_CONNECTION_AUTHENTICATED            LogLineInformation_LogClassification = 34 // "connection authenticated: "
	...
	LogLineInformation_SKIPPING_MAINTENANCE_PERMISSION_DENIED LogLineInformation_LogClassification = 69 // "permission denied to {vacuum,analyze,execute CLUSTER on,execute REPACK on} ..., skipping it"
	// Locks
	...
	LogLineInformation_VALUE_OUT_OF_RANGE                  LogLineInformation_LogClassification = 141 // "... out of range", "... field value out of range", "numeric field overflow" (for non-integer types; integers use INTEGER_OUT_OF_RANGE)
	LogLineInformation_OBJECT_DOES_NOT_EXIST               LogLineInformation_LogClassification = 142 // "<object type> ... does not exist" for object types without a dedicated classification (role, type, schema, index, collation, extension, ...); relations/columns/functions/operators use their own
	LogLineInformation_ROW_LEVEL_SECURITY_VIOLATION        LogLineInformation_LogClassification = 143 // "new row violates row-level security policy for table ...", "query would be affected by row-level security policy for table ..." (errcode 42501)
	LogLineInformation_WITH_CHECK_OPTION_VIOLATION         LogLineInformation_LogClassification = 144 // "new row violates check option for view ..." (errcode 44000)
	LogLineInformation_CANNOT_MODIFY_VIEW                  LogLineInformation_LogClassification = 145 // "cannot insert into/update/delete from/merge into [column ... of] view ..." for non-updatable views (errcodes 55000, 0A000)
	LogLineInformation_SQL_JSON_ERROR                      LogLineInformation_LogClassification = 146 // JSON / jsonpath / SQL-JSON processing errors (errcodes vary: 2203x SQL/JSON subclass, plus 22P02, 22023, 42601, 0A000, ...)
	LogLineInformation_PARTITION_ERROR                     LogLineInformation_LogClassification = 147 // partitioning DDL/operation errors: invalid bounds/keys, overlaps, cannot attach/detach/merge/split, "X is not a partition", ... (errcodes vary: 42P16, 42P17, 0A000, 42809; runtime routing/constraint failures use CHECK_CONSTRAINT_VIOLATION)
	LogLineInformation_OBJECT_ALREADY_EXISTS               LogLineInformation_LogClassification = 148 // "<object type> ... already exists" for any object type (relation, type, column, constraint, function, ...) (duplicate_* errcodes: 42710, 42P07, 42701, 42723)
	LogLineInformation_WRONG_OBJECT_TYPE                   LogLineInformation_LogClassification = 149 // operation attempted on the wrong kind of object: "\"...\" is [not] a[n] <object type>", "ALTER action ... cannot be performed on relation ..." (errcode 42809)
...
var (
	LogLineInformation_LogClassification_name = map[int32]string{
		...
		69:   "SKIPPING_MAINTENANCE_PERMISSION_DENIED",
		70:   "LOCK_ACQUIRED",
		71:   "LOCK_WAITING",
		72:   "LOCK_TIMEOUT",
		...
		141:  "VALUE_OUT_OF_RANGE",
		142:  "OBJECT_DOES_NOT_EXIST",
		143:  "ROW_LEVEL_SECURITY_VIOLATION",
		144:  "WITH_CHECK_OPTION_VIOLATION",
		145:  "CANNOT_MODIFY_VIEW",
		146:  "SQL_JSON_ERROR",
		147:  "PARTITION_ERROR",
		148:  "OBJECT_ALREADY_EXISTS",
		149:  "WRONG_OBJECT_TYPE",
	...
	LogLineInformation_LogClassification_value = map[string]int32{
		...
		"SKIPPING_MAINTENANCE_PERMISSION_DENIED": 69,
		"LOCK_ACQUIRED":                          70,
		"LOCK_WAITING":                           71,
		"LOCK_TIMEOUT":                           72,
		...
		"VALUE_OUT_OF_RANGE":                     141,
		"OBJECT_DOES_NOT_EXIST":                  142,
		"ROW_LEVEL_SECURITY_VIOLATION":           143,
		"WITH_CHECK_OPTION_VIOLATION":            144,
		"CANNOT_MODIFY_VIEW":                     145,
		"SQL_JSON_ERROR":                         146,
		"PARTITION_ERROR":                        147,
		"OBJECT_ALREADY_EXISTS":                  148,
		"WRONG_OBJECT_TYPE":                      149,
...
type LogFileReference struct {
	...
	Uuid            string                           `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"` // 2-4 are deprecated and shouldn't be used
...
type QuerySample struct {
	...
	Normalized    bool                      `protobuf:"varint,30,opt,name=normalized,proto3" json:"normalized,omitempty"`
}
...
func (x *QuerySample) GetNormalized() bool {
	if x != nil {
		return x.Normalized
	}
	return false
...
var file_compact_log_snapshot_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
