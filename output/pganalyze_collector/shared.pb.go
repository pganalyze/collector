...
type NullTimestamp struct {
	Valid                bool                 `protobuf:"varint,1,opt,name=valid" json:"valid,omitempty"`
	Value                *timestamp.Timestamp `protobuf:"bytes,2,opt,name=value" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type SystemInformation struct {
	...
	BootTime             *timestamp.Timestamp     `protobuf:"bytes,10,opt,name=boot_time,json=bootTime" json:"boot_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
type SystemInformationAmazonRDS struct {
	...
	LatestRestorableTime       *timestamp.Timestamp `protobuf:"bytes,13,opt,name=latest_restorable_time,json=latestRestorableTime" json:"latest_restorable_time,omitempty"`
	...
	CreatedAt                  *timestamp.Timestamp `protobuf:"bytes,18,opt,name=created_at,json=createdAt" json:"created_at,omitempty"`
