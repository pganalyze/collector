...
func (QueryExplainInformation_ExplainFormat) EnumDescriptor() ([]byte, []int) {
	return file_shared_proto_rawDescGZIP(), []int{13, 0}
}
...
func (QueryExplainInformation_ExplainSource) EnumDescriptor() ([]byte, []int) {
	return file_shared_proto_rawDescGZIP(), []int{13, 1}
}
...
const (
	...
	SystemInformation_PLANETSCALE_SYSTEM      SystemInformation_SystemType = 8
)
...
func (SystemInformation_SystemType) EnumDescriptor() ([]byte, []int) {
	return file_shared_proto_rawDescGZIP(), []int{16, 0}
}
...
type QueryReference struct {
	...
	Toplevel    *bool  `protobuf:"varint,4,opt,name=toplevel,proto3,oneof" json:"toplevel,omitempty"`
}
...
func (x *QueryReference) GetToplevel() bool {
...
type System struct {
	...
	SchedulerStatistic            *SchedulerStatistic         `protobuf:"bytes,10,opt,name=scheduler_statistic,json=schedulerStatistic,proto3" json:"scheduler_statistic,omitempty"` // Deprecated in v0.71.0: now stored every minute in system_statistics
	MemoryStatistic               *MemoryStatistic            `protobuf:"bytes,11,opt,name=memory_statistic,json=memoryStatistic,proto3" json:"memory_statistic,omitempty"`          // Deprecated in v0.71.0: now stored every minute in system_statistics
	...
	CpuStatistics                 []*CPUStatistic             `protobuf:"bytes,14,rep,name=cpu_statistics,json=cpuStatistics,proto3" json:"cpu_statistics,omitempty"` // Deprecated in v0.71.0: now stored every minute in system_statistics
	...
	NetworkStatistics             []*NetworkStatistic         `protobuf:"bytes,16,rep,name=network_statistics,json=networkStatistics,proto3" json:"network_statistics,omitempty"` // Deprecated in v0.71.0: now stored every minute in system_statistics
	...
	DiskStatistics                []*DiskStatistic            `protobuf:"bytes,19,rep,name=disk_statistics,json=diskStatistics,proto3" json:"disk_statistics,omitempty"` // Deprecated in v0.71.0: now stored every minute in system_statistics
	...
	DiskPartitionStatistics       []*DiskPartitionStatistic   `protobuf:"bytes,22,rep,name=disk_partition_statistics,json=diskPartitionStatistics,proto3" json:"disk_partition_statistics,omitempty"` // Deprecated in v0.71.0: now stored every minute in system_statistics
	SystemStatistics              []*SystemStatistic          `protobuf:"bytes,23,rep,name=system_statistics,json=systemStatistics,proto3" json:"system_statistics,omitempty"`
...
func (x *System) GetSystemStatistics() []*SystemStatistic {
	if x != nil {
		return x.SystemStatistics
	}
	return nil
}
...
type SystemStatistic struct {
	...
	Cpu           *CPUStatistic          `protobuf:"bytes,2,opt,name=cpu,proto3" json:"cpu,omitempty"`
	Memory        *MemoryStatistic       `protobuf:"bytes,3,opt,name=memory,proto3" json:"memory,omitempty"`
	Network       *NetworkStatistic      `protobuf:"bytes,4,opt,name=network,proto3" json:"network,omitempty"`
	Disks         []*DiskStatistic       `protobuf:"bytes,5,rep,name=disks,proto3" json:"disks,omitempty"`
	XlogUsedBytes uint64                 `protobuf:"varint,6,opt,name=xlog_used_bytes,json=xlogUsedBytes,proto3" json:"xlog_used_bytes,omitempty"` // Size of the WAL directory, in bytes (not necessarily the same as used bytes on the WAL partition!)
}

func (x *SystemStatistic) Reset() {
	*x = SystemStatistic{}
	if protoimpl.UnsafeEnabled {
...
func (x *SystemStatistic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SystemStatistic) ProtoMessage() {}

func (x *SystemStatistic) ProtoReflect() protoreflect.Message {
	mi := &file_shared_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SystemStatistic.ProtoReflect.Descriptor instead.
func (*SystemStatistic) Descriptor() ([]byte, []int) {
	return file_shared_proto_rawDescGZIP(), []int{15}
}

func (x *SystemStatistic) GetCollectedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *SystemStatistic) GetCpu() *CPUStatistic {
	if x != nil {
		return x.Cpu
	}
	return nil
...
func (x *SystemStatistic) GetMemory() *MemoryStatistic {
	if x != nil {
		return x.Memory
	}
	return nil
...
func (x *SystemStatistic) GetNetwork() *NetworkStatistic {
	if x != nil {
		return x.Network
	}
	return nil
...
func (x *SystemStatistic) GetDisks() []*DiskStatistic {
	if x != nil {
		return x.Disks
	}
	return nil
...
func (x *SystemStatistic) GetXlogUsedBytes() uint64 {
	if x != nil {
		return x.XlogUsedBytes
	}
	return 0
...
func (x *SystemInformation) GetCrunchyBridge() *SystemInformationCrunchyBridge {
	if x, ok := x.GetInfo().(*SystemInformation_CrunchyBridge); ok {
		return x.CrunchyBridge
	}
	return nil
}

func (x *SystemInformation) GetAzure() *SystemInformationAzure {
	if x, ok := x.GetInfo().(*SystemInformation_Azure); ok {
		return x.Azure
	}
	return nil
}
...
func (*SystemInformation_CrunchyBridge) isSystemInformation_Info() {}

func (*SystemInformation_Azure) isSystemInformation_Info() {}
...
func (x *SystemInformationCrunchyBridge) Reset() {
	*x = SystemInformationCrunchyBridge{}
	if protoimpl.UnsafeEnabled {
...
func (x *SystemInformationCrunchyBridge) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SystemInformationCrunchyBridge) ProtoMessage() {}

func (x *SystemInformationCrunchyBridge) ProtoReflect() protoreflect.Message {
	mi := &file_shared_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *SystemInformationCrunchyBridge) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
type SystemInformationAzure struct {
	...
	HighAvailabilityState    string                 `protobuf:"bytes,11,opt,name=high_availability_state,json=highAvailabilityState,proto3" json:"high_availability_state,omitempty"`
	...
	HighAvailabilityEnabled  bool                   `protobuf:"varint,14,opt,name=high_availability_enabled,json=highAvailabilityEnabled,proto3" json:"high_availability_enabled,omitempty"`
	...
	CoordinatorServerEdition string                 `protobuf:"bytes,21,opt,name=coordinator_server_edition,json=coordinatorServerEdition,proto3" json:"coordinator_server_edition,omitempty"`
	...
	MaintenanceCustomWindow  bool                   `protobuf:"varint,23,opt,name=maintenance_custom_window,json=maintenanceCustomWindow,proto3" json:"maintenance_custom_window,omitempty"`
	MaintenanceDayOfWeek     int32                  `protobuf:"varint,24,opt,name=maintenance_day_of_week,json=maintenanceDayOfWeek,proto3" json:"maintenance_day_of_week,omitempty"`
	...
	MaintenanceStartMinute   int32                  `protobuf:"varint,26,opt,name=maintenance_start_minute,json=maintenanceStartMinute,proto3" json:"maintenance_start_minute,omitempty"`
}

func (x *SystemInformationAzure) Reset() {
	*x = SystemInformationAzure{}
	if protoimpl.UnsafeEnabled {
...
func (x *SystemInformationAzure) GetHighAvailabilityState() string {
	if x != nil {
		return x.HighAvailabilityState
	}
	return ""
}
...
func (x *SystemInformationAzure) GetCoordinatorServerEdition() string {
	if x != nil {
		return x.CoordinatorServerEdition
	}
	return ""
}
...
func (x *SystemInformationAzure) GetMaintenanceCustomWindow() bool {
	if x != nil {
		return x.MaintenanceCustomWindow
	}
	return false
}
...
func (x *SystemInformationAzure) GetMaintenanceStartMinute() int32 {
	if x != nil {
		return x.MaintenanceStartMinute
	}
	return 0
}
...
var file_shared_proto_rawDesc = []byte{
	...
	0x9e, 0x01, 0x0a, 0x0e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x69,
	0x64, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	0x73, 0x65, 0x49, 0x64, 0x78, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64,
	...
	,
	...
	0x6e, 0x2e, 0x45, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x52,
	0x0d, 0x65, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x61,
	0x0a, 0x0e, 0x65, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3a, 0x2e, 0x70, 0x67, 0x61, 0x6e, 0x61, 0x6c, 0x79,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x6d, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x04,
	...
	0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72,
	0x6d, 0x46, 0x61, 0x6d, 0x69, 0x6c, 0x79, 0x12, 0x29, 0x0a, 0x10, 0x70, 0x6c, 0x61, 0x74, 0x66,
	0x6f, 0x72, 0x6d, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0f, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x56, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x15, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x69, 0x7a, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x23, 0x0a, 0x0d, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x86, 0x01, 0x0a, 0x16, 0x44, 0x69, 0x73, 0x6b,
	0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74,
	0x69, 0x63, 0x12, 0x2c, 0x0a, 0x12, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x70, 0x61, 0x72, 0x74, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10,
	...
	0x22, 0xe1, 0x01, 0x0a, 0x08, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x75, 0x6e, 0x12, 0x0e, 0x0a,
	...
	0x68, 0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18,
	...
	0x72, 0x6f, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x5f, 0x70,
	0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e,
	0x64, 0x50, 0x69, 0x64, 0x2a, 0x1b, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x75, 0x6e,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x58, 0x50, 0x4c, 0x41, 0x49, 0x4e, 0x10,
...
var file_shared_proto_goTypes = []interface{}{
	...
	(*QueryPlanReference)(nil),                 // 15: pganalyze.collector.QueryPlanReference
	(*QueryInformation)(nil),                   // 16: pganalyze.collector.QueryInformation
	(*QueryExplainInformation)(nil),            // 17: pganalyze.collector.QueryExplainInformation
	(*System)(nil),                             // 18: pganalyze.collector.System
	(*SystemStatistic)(nil),                    // 19: pganalyze.collector.SystemStatistic
	(*SystemInformation)(nil),                  // 20: pganalyze.collector.SystemInformation
	(*SystemInformationSelfHosted)(nil),        // 21: pganalyze.collector.SystemInformationSelfHosted
	(*SystemInformationAmazonRDS)(nil),         // 22: pganalyze.collector.SystemInformationAmazonRDS
	(*SystemInformationCrunchyBridge)(nil),     // 23: pganalyze.collector.SystemInformationCrunchyBridge
	(*SystemInformationAzure)(nil),             // 24: pganalyze.collector.SystemInformationAzure
	(*SchedulerStatistic)(nil),                 // 25: pganalyze.collector.SchedulerStatistic
	(*MemoryStatistic)(nil),                    // 26: pganalyze.collector.MemoryStatistic
	(*CPUInformation)(nil),                     // 27: pganalyze.collector.CPUInformation
	(*CPUReference)(nil),                       // 28: pganalyze.collector.CPUReference
	(*CPUStatistic)(nil),                       // 29: pganalyze.collector.CPUStatistic
	(*NetworkReference)(nil),                   // 30: pganalyze.collector.NetworkReference
	(*NetworkStatistic)(nil),                   // 31: pganalyze.collector.NetworkStatistic
	(*DiskReference)(nil),                      // 32: pganalyze.collector.DiskReference
	(*DiskInformation)(nil),                    // 33: pganalyze.collector.DiskInformation
	(*DiskStatistic)(nil),                      // 34: pganalyze.collector.DiskStatistic
	(*DiskPartitionReference)(nil),             // 35: pganalyze.collector.DiskPartitionReference
	(*DiskPartitionInformation)(nil),           // 36: pganalyze.collector.DiskPartitionInformation
	(*DiskPartitionStatistic)(nil),             // 37: pganalyze.collector.DiskPartitionStatistic
	(*QueryRun)(nil),                           // 38: pganalyze.collector.QueryRun
	nil,                                        // 39: pganalyze.collector.SystemInformation.ResourceTagsEntry
	(*timestamppb.Timestamp)(nil),              // 40: google.protobuf.Timestamp
}
var file_shared_proto_depIdxs = []int32{
	40, // 0: pganalyze.collector.NullTimestamp.value:type_name -> google.protobuf.Timestamp
	...
	20, // 3: pganalyze.collector.System.system_information:type_name -> pganalyze.collector.SystemInformation
	25, // 4: pganalyze.collector.System.scheduler_statistic:type_name -> pganalyze.collector.SchedulerStatistic
	26, // 5: pganalyze.collector.System.memory_statistic:type_name -> pganalyze.collector.MemoryStatistic
	27, // 6: pganalyze.collector.System.cpu_information:type_name -> pganalyze.collector.CPUInformation
	28, // 7: pganalyze.collector.System.cpu_references:type_name -> pganalyze.collector.CPUReference
	29, // 8: pganalyze.collector.System.cpu_statistics:type_name -> pganalyze.collector.CPUStatistic
	30, // 9: pganalyze.collector.System.network_references:type_name -> pganalyze.collector.NetworkReference
	31, // 10: pganalyze.collector.System.network_statistics:type_name -> pganalyze.collector.NetworkStatistic
	32, // 11: pganalyze.collector.System.disk_references:type_name -> pganalyze.collector.DiskReference
	33, // 12: pganalyze.collector.System.disk_informations:type_name -> pganalyze.collector.DiskInformation
	34, // 13: pganalyze.collector.System.disk_statistics:type_name -> pganalyze.collector.DiskStatistic
	35, // 14: pganalyze.collector.System.disk_partition_references:type_name -> pganalyze.collector.DiskPartitionReference
	36, // 15: pganalyze.collector.System.disk_partition_informations:type_name -> pganalyze.collector.DiskPartitionInformation
	37, // 16: pganalyze.collector.System.disk_partition_statistics:type_name -> pganalyze.collector.DiskPartitionStatistic
	19, // 17: pganalyze.collector.System.system_statistics:type_name -> pganalyze.collector.SystemStatistic
	40, // 18: pganalyze.collector.SystemStatistic.collected_at:type_name -> google.protobuf.Timestamp
	29, // 19: pganalyze.collector.SystemStatistic.cpu:type_name -> pganalyze.collector.CPUStatistic
	26, // 20: pganalyze.collector.SystemStatistic.memory:type_name -> pganalyze.collector.MemoryStatistic
	31, // 21: pganalyze.collector.SystemStatistic.network:type_name -> pganalyze.collector.NetworkStatistic
	34, // 22: pganalyze.collector.SystemStatistic.disks:type_name -> pganalyze.collector.DiskStatistic
	3,  // 23: pganalyze.collector.SystemInformation.type:type_name -> pganalyze.collector.SystemInformation.SystemType
	21, // 24: pganalyze.collector.SystemInformation.self_hosted:type_name -> pganalyze.collector.SystemInformationSelfHosted
	22, // 25: pganalyze.collector.SystemInformation.amazon_rds:type_name -> pganalyze.collector.SystemInformationAmazonRDS
	23, // 26: pganalyze.collector.SystemInformation.crunchy_bridge:type_name -> pganalyze.collector.SystemInformationCrunchyBridge
	24, // 27: pganalyze.collector.SystemInformation.azure:type_name -> pganalyze.collector.SystemInformationAzure
	39, // 28: pganalyze.collector.SystemInformation.resource_tags:type_name -> pganalyze.collector.SystemInformation.ResourceTagsEntry
	40, // 29: pganalyze.collector.SystemInformation.boot_time:type_name -> google.protobuf.Timestamp
	40, // 30: pganalyze.collector.SystemInformationAmazonRDS.latest_restorable_time:type_name -> google.protobuf.Timestamp
	40, // 31: pganalyze.collector.SystemInformationAmazonRDS.created_at:type_name -> google.protobuf.Timestamp
	40, // 32: pganalyze.collector.SystemInformationCrunchyBridge.created_at:type_name -> google.protobuf.Timestamp
	40, // 33: pganalyze.collector.SystemInformationAzure.created_at:type_name -> google.protobuf.Timestamp
	40, // 34: pganalyze.collector.QueryRun.started_at:type_name -> google.protobuf.Timestamp
	40, // 35: pganalyze.collector.QueryRun.finished_at:type_name -> google.protobuf.Timestamp
...
func file_shared_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_shared_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPlanReference); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_shared_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SystemInformationCrunchyBridge); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_shared_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SystemInformationAzure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_shared_proto_msgTypes[10].OneofWrappers = []interface{}{}
	file_shared_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*SystemInformation_SelfHosted)(nil),
		(*SystemInformation_AmazonRds)(nil),
		(*SystemInformation_CrunchyBridge)(nil),
		(*SystemInformation_Azure)(nil),
	}
	type x struct{}
