...
type Statement struct {
	...
	// Postgres 9.4+
	Queryid NullableInt `msg:"queryid"`

	// Postgres 9.5+
	MinTime    NullableFloat `msg:"min_time"`
	MaxTime    NullableFloat `msg:"max_time"`
	MeanTime   NullableFloat `msg:"mean_time"`
	StddevTime NullableFloat `msg:"stddev_time"`
}
